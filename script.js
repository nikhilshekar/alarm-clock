...
const setHours = document.querySelector("#hrs");
const setMinutes = document.querySelector("#mins");
const setSeconds = document.querySelector("#secs");
...
function addAlaramToDom(time, intervalId) {
  ...
  alarm.innerHTML = `
              ...
              <button class="btn btn-danger" data-id=${intervalId}><i class="fa fa-trash"></i></button>
              `;
  const deleteButton = alarm.querySelector(".btn-danger");
